...
import 'package:app_stage_project/modules/language/git/descreption_screene.dart';
...
class GitScreene extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              buttonDetails(pressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>GitDescreption(),),);
