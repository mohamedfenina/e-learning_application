...
class SwiftQuiz extends StatefulWidget {
  const SwiftQuiz({Key? key}) : super(key: key);

  @override
  _SwiftQuizState createState() => _SwiftQuizState();
}

class _SwiftQuizState extends State<SwiftQuiz> {
