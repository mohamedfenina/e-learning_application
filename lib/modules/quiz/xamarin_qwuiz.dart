...
class XamarinQuiz extends StatefulWidget {
  const XamarinQuiz({Key? key}) : super(key: key);

  @override
  _XamarinQuizState createState() => _XamarinQuizState();
}

class _XamarinQuizState extends State<XamarinQuiz> {
